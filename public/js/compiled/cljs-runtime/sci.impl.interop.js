...
sci.impl.interop.get_static_field = (function sci$impl$interop$get_static_field(p__61848){
var vec__61851 = p__61848;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61851,(0),null);
var field_name_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61851,(1),null);
...
var G__61861 = cljs.core.count(args__$1);
switch (G__61861) {
case (0):
return (new ctor());
...
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(p__61866,args){
var vec__61867 = p__61866;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61867,(0),null);
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61867,(1),null);
...
sci.impl.interop.fully_qualify_class = (function sci$impl$interop$fully_qualify_class(p__61871,sym){
var map__61872 = p__61871;
var map__61872__$1 = cljs.core.__destructure_map(map__61872);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61872__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61872__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
...
sci.impl.interop.resolve_class_opts = (function sci$impl$interop$resolve_class_opts(p__61874,sym){
var map__61875 = p__61874;
var map__61875__$1 = cljs.core.__destructure_map(map__61875);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61875__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61875__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__61879 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61879,(0),null);
