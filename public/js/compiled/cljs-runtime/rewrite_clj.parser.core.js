...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__58146 = cljs.core.get_global_hierarchy;
return (fexpr__58146.cljs$core$IFn$_invoke$arity$0 ? fexpr__58146.cljs$core$IFn$_invoke$arity$0() : fexpr__58146.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__58150_SHARP_){
var _STAR_delimiter_STAR__orig_val__58151 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__58152 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__58152);

try{return rewrite_clj.parser.core.parse_next(p1__58150_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__58151);
}}));
});
...
while(true){
if((i__5770__auto___58201 < len__5769__auto___58199)){
args__5775__auto__.push((arguments[i__5770__auto___58201]));

var G__58202 = (i__5770__auto___58201 + (1));
i__5770__auto___58201 = G__58202;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__58157){
var vec__58158 = p__58157;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58158,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq58153){
...
var G__58156 = cljs.core.first(seq58153__$2);
var seq58153__$3 = cljs.core.next(seq58153__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58154,G__58155,G__58156,seq58153__$3);
}));
...
var G__58176 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__58176)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__58176)){
...
return cljs.core.cons((function (){var G__58185 = rewrite_clj.reader.peek(reader);
switch (G__58185) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__58176)){
