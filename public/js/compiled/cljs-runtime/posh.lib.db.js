...
var G__23960 = cljs.core.first(poshdb);
var G__23960__$1 = (((G__23960 instanceof cljs.core.Keyword))?G__23960.fqn:null);
switch (G__23960__$1) {
case "db":
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23960__$1)].join('')));
...
var G__24030 = cljs.core.cons(pdb,path);
var G__24031 = posh.lib.db.get_parent_db(pdb);
path = G__24030;
pdb = G__24031;
continue;
} else {
...
var G__24037 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__24037;
continue;
}
break;
...
var map__23982 = filters;
var map__23982__$1 = cljs.core.__destructure_map(map__23982);
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23982__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23982__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23982__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23982__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__5045__auto__ = db;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var fexpr__23986 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__23986.cljs$core$IFn$_invoke$arity$1 ? fexpr__23986.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__23986.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__23987 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__23987.cljs$core$IFn$_invoke$arity$2 ? fexpr__23987.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__23987.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__23988 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__23988.cljs$core$IFn$_invoke$arity$2 ? fexpr__23988.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__23988.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__23992 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__23992.cljs$core$IFn$_invoke$arity$2 ? fexpr__23992.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__23992.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__23994 = db__$4;
var G__23995 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__23993 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__24005,poshdb){
var map__24006 = p__24005;
var map__24006__$1 = cljs.core.__destructure_map(map__24006);
var posh_tree = map__24006__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24006__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24006__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__24008 = (function (){var G__24013 = posh_tree;
var G__24014 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__24013,G__24014) : posh.lib.db.poshdb__GT_db.call(null,G__24013,G__24014));
})();
var G__24009 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__24007 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__24007.cljs$core$IFn$_invoke$arity$2 ? fexpr__24007.cljs$core$IFn$_invoke$arity$2(G__24008,G__24009) : fexpr__24007.call(null,G__24008,G__24009));
}
});
