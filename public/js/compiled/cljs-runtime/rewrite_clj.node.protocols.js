...
var rewrite_clj$node$protocols$Node$tag$dyn_57063 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_57063(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_57100 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_57100(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_57109 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_57109(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_57111 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_57111(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_57116 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_57116(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_57122 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_57122(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57004_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__57004_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_57147 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_57147(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_57163 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_57163(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_57179 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_57179(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_57194 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_57194(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_57220 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_57220(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_57225 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_57225(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_57229 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_57229(node);
}
});
...
var map__57052 = cljs.core.meta(node);
var map__57052__$1 = cljs.core.__destructure_map(map__57052);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57052__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57052__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57052__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57052__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__57053,p__57054){
var vec__57055 = p__57053;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57055,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57055,(1),null);
var vec__57058 = p__57054;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57058,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57058,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__57061 = col_extent;
if((row_extent === (0))){
return (G__57061 + col);
} else {
return G__57061;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__57062 = rewrite_clj.node.protocols.children(node);
var G__57062__$1 = (((G__57062 == null))?null:cljs.core.first(G__57062));
if((G__57062__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__57062__$1);
}
} else {
