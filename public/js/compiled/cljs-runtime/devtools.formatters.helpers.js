...
var G__17704 = devtools.prefs.pref(v);
v = G__17704;
continue;
} else {
return v;
...
}catch (e17554){var _e__16240__auto__ = e17554;
return false;
}})();
...
}catch (e17558){var _e__16240__auto__ = e17558;
return false;
}})();
...
}catch (e17561){var _e__16240__auto__ = e17561;
return false;
}}
}
});
...
var vec__17578 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17578,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17578,(1),null);
...
return cljs.core.some((function (p1__17591_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__17591_SHARP_);
}),template);
});
