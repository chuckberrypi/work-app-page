...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13944 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13944(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13945 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13945(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13961 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13961(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13975 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13975(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13980 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13980(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13981 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13981(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13933,callback){
var map__13934 = p__13933;
var map__13934__$1 = cljs.core.__destructure_map(map__13934);
var input = map__13934__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13934__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13934__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
