...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_24499 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_24499(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_24500 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_24500(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24503 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24503(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24504 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24504(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24507 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24507(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24508 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24508(reader);
}
});
...
var G__24535 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__24536 = s.append(c);
c = G__24535;
s = G__24536;
continue;
}
