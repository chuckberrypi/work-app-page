...
var G__21524 = o;
reagent.impl.template.goog$module$goog$object.set(G__21524,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__21525 = o;
reagent.impl.template.goog$module$goog$object.set(G__21525,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__21529 = props;
var G__21529__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21529,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21529);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21529__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21530 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21530,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21530;
}
})(),id_class);
...
var G__21531 = (cljs.core.count(argv) - first_child);
switch (G__21531) {
case (0):
...
var vec__21532 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21532,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21532,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21532,(2),null);
...
var temp__5808__auto___21552 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21552 == null)){
} else {
var key_21553 = temp__5808__auto___21552;
(jsprops.key = key_21553);
}
...
var temp__5808__auto___21554 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21554 == null)){
} else {
var key_21555 = temp__5808__auto___21554;
(jsprops.key = key_21555);
}
...
var temp__5808__auto___21556 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___21556 == null)){
} else {
var key_21557 = temp__5808__auto___21556;
(jsprops.key = key_21557);
}
...
var temp__5808__auto___21558 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
var temp__5808__auto___21560 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21560 == null)){
} else {
var key_21561 = temp__5808__auto___21560;
(jsprops.key = key_21561);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21535_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21535_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21536 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21536,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21536,(1),null);
...
break;
default:
var G__21563 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
...
*/
reagent.impl.template.t_reagent$impl$template21542 = (function (opts,id,fn_to_element,parse_fn,meta21543){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21542.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21544,meta21543__$1){
var self__ = this;
var _21544__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21542(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21543__$1));
}));

(reagent.impl.template.t_reagent$impl$template21542.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21544){
var self__ = this;
var _21544__$1 = this;
return self__.meta21543;
}));

(reagent.impl.template.t_reagent$impl$template21542.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21542.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21542.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21542.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21542.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21542.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21543","meta21543",1070916931,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21542.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21542.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21542");

(reagent.impl.template.t_reagent$impl$template21542.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template21542");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21542.
 */
reagent.impl.template.__GT_t_reagent$impl$template21542 = (function reagent$impl$template$__GT_t_reagent$impl$template21542(opts,id,fn_to_element,parse_fn,meta21543){
return (new reagent.impl.template.t_reagent$impl$template21542(opts,id,fn_to_element,parse_fn,meta21543));
});
...
return (new reagent.impl.template.t_reagent$impl$template21542(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
