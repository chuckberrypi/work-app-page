...
var sq_dev_from_mean = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__60571_SHARP_){
return (p1__60571_SHARP_ * p1__60571_SHARP_);
}),dev_from_mean);
...
var indicies = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__60574,n){
var vec__60575 = p__60574;
var max_so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60575,(0),null);
var indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60575,(1),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60575,(2),null);
if((n == null)){
...
var vec__60581 = zprint.util.find_max(coll_vec);
var max_number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60581,(0),null);
var indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60581,(1),null);
var length = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60581,(2),null);
...
var vec__60584 = cljs.core.split_at(index,columns);
var beginning = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60584,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60584,(1),null);
...
if((row_count > (2))){
var vec__60587 = zprint.util.remove_max_not_half(column);
var first_indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60587,(0),null);
var first_column_wo_max = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60587,(1),null);
...
var vec__60590 = zprint.util.remove_max_not_half(first_column_wo_max);
var second_indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60590,(0),null);
var second_column_wo_max = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60590,(1),null);
...
var G__60636 = cljs.core.next(coll__$1);
var G__60637 = (index + (1));
var G__60638 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,(((index >= last_good_col))?null:zprint.util.size.cljs$core$IFn$_invoke$arity$2(cljs.core.first(coll__$1),no_string_adj_QMARK_)));
coll__$1 = G__60636;
index = G__60637;
out = G__60638;
continue;
...
var max_width_vec = cljs.core.second(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__60609,index){
var vec__60610 = p__60609;
var columns__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60610,(0),null);
var max_width_vec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60610,(1),null);
var vec__60613 = zprint.util.column_width_variance(max_variance,columns__$1,index);
var max_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60613,(0),null);
var new_columns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60613,(1),null);
...
return cljs.core.second(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__60621,column_max_width){
var vec__60622 = p__60621;
var current_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60622,(0),null);
var cumulative_widths = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60622,(1),null);
