...
var G__56867 = clojure.zip.node(loc);
var fexpr__56866 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__56866.cljs$core$IFn$_invoke$arity$1 ? fexpr__56866.cljs$core$IFn$_invoke$arity$1(G__56867) : fexpr__56866.call(null,G__56867));
});
/**
...
var G__56870 = clojure.zip.node(loc);
var fexpr__56869 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__56869.cljs$core$IFn$_invoke$arity$1 ? fexpr__56869.cljs$core$IFn$_invoke$arity$1(G__56870) : fexpr__56869.call(null,G__56870));
} else {
...
var fexpr__56879 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__56879.cljs$core$IFn$_invoke$arity$2 ? fexpr__56879.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__56879.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__56891 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56891,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56891,(1),null);
var vec__56894 = clojure.zip.children(loc);
var seq__56895 = cljs.core.seq(vec__56894);
var first__56896 = cljs.core.first(seq__56895);
var seq__56895__$1 = cljs.core.next(seq__56895);
var c = first__56896;
var cnext = seq__56895__$1;
var cs = vec__56894;
...
var vec__56898 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56898,(0),null);
var map__56901 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56898,(1),null);
var map__56901__$1 = cljs.core.__destructure_map(map__56901);
var path = map__56901__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56901__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56901__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56901__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56901__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56901__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__56943 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56943,(0),null);
var map__56946 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56943,(1),null);
var map__56946__$1 = cljs.core.__destructure_map(map__56946);
var path = map__56946__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56946__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__56947 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56946__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__56948 = cljs.core.seq(vec__56947);
var first__56949 = cljs.core.first(seq__56948);
var seq__56948__$1 = cljs.core.next(seq__56948);
var r = first__56949;
var rnext = seq__56948__$1;
var rs = vec__56947;
...
var vec__56950 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56950,(0),null);
var map__56953 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56950,(1),null);
var map__56953__$1 = cljs.core.__destructure_map(map__56953);
var path = map__56953__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56953__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56953__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__56954 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56954,(0),null);
var map__56957 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56954,(1),null);
var map__56957__$1 = cljs.core.__destructure_map(map__56957);
var path = map__56957__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56957__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56957__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__56958 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56958,(0),null);
var map__56961 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56958,(1),null);
var map__56961__$1 = cljs.core.__destructure_map(map__56961);
var path = map__56961__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56961__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56961__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__56962 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56962,(0),null);
var map__56965 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56962,(1),null);
var map__56965__$1 = cljs.core.__destructure_map(map__56965);
var path = map__56965__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56965__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__56966 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56966,(0),null);
var map__56969 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56966,(1),null);
var map__56969__$1 = cljs.core.__destructure_map(map__56969);
var path = map__56969__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56969__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56973,(1),null);
...
var i__5770__auto___57043 = (0);
while(true){
if((i__5770__auto___57043 < len__5769__auto___57042)){
args__5775__auto__.push((arguments[i__5770__auto___57043]));

var G__57044 = (i__5770__auto___57043 + (1));
i__5770__auto___57043 = G__57044;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq56976){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56977,G__56978,seq56976__$2);
}));
...
var G__57048 = clojure.zip.rightmost(child);
loc__$1 = G__57048;
continue;
} else {
return loc__$1;
...
var vec__56997 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56997,(0),null);
var map__57000 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56997,(1),null);
var map__57000__$1 = cljs.core.__destructure_map(map__57000);
var path = map__57000__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57000__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57000__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57000__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57000__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__57049 = clojure.zip.rightmost(child);
loc__$1 = G__57049;
continue;
} else {
return loc__$1;
