...
var clojure$test$check$results$Result$pass_QMARK_$dyn_31716 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_31716(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_31722 = (function (result){
var x__5393__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_31722(result);
}
});
