...
var G__61742 = (cljs.core.truth_(next_lf)?cljs.core.subs.cljs$core$IFn$_invoke$arity$2(input,(next_lf + (1))):null);
var G__61743 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,chunk);
input = G__61742;
out = G__61743;
continue;
}
...
var G__61747 = moving_up;
var G__61748 = (total_up + up_size);
ploc = G__61747;
total_up = G__61748;
continue;
}
...
var vec__61622 = zprint.comment.left_or_up(zloc);
var up_size = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61622,(0),null);
var next_zloc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61622,(1),null);
var ploc = next_zloc;
...
var vec__61646 = zprint.comment.left_or_up(ploc);
var up_size__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61646,(0),null);
var next_zloc__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61646,(1),null);
if(cljs.core.truth_(length_right_of_newline)){
return (length_right_of_newline + indent_before);
} else {
var G__61751 = next_zloc__$1;
var G__61752 = ((indent_before + cljs.core.count(zstr)) + up_size__$1);
ploc = G__61751;
indent_before = G__61752;
continue;
}
}
break;
...
while(true){
var vec__61661 = (function (){var tnloc = (zprint.zfns.ztag.cljs$core$IFn$_invoke$arity$1 ? zprint.zfns.ztag.cljs$core$IFn$_invoke$arity$1(nloc) : zprint.zfns.ztag.call(null,nloc));
...
var tnloc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61661,(0),null);
var spaces__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61661,(1),null);
if((tnloc == null)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tnloc,new cljs.core.Keyword(null,"newline","newline",1790071323))){
var G__61754 = rewrite_clj.zip.left_STAR_(nloc);
var G__61755 = spaces__$1;
var G__61756 = true;
nloc = G__61754;
spaces = G__61755;
passed_nl_QMARK_ = G__61756;
continue;
} else {
...
var G__61758 = rewrite_clj.zip.left_STAR_(nloc);
var G__61759 = (rewrite_clj.zip.length(nloc) + spaces__$1);
var G__61760 = passed_nl_QMARK_;
nloc = G__61758;
spaces = G__61759;
passed_nl_QMARK_ = G__61760;
continue;
...
var seq_after_space = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__61665_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__61665_SHARP_," ");
}),rev_seq);
...
var seq_after_space = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__61668_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__61668_SHARP_," ");
 ...
 */
zprint.comment.wrap_comment = (function zprint$comment$wrap_comment(width,p__61669,start){
var vec__61670 = p__61669;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61670,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61670,(1),null);
var stype = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61670,(2),null);
var element = vec__61670;
 ...
 */
zprint.comment.loc_vec = (function zprint$comment$loc_vec(start,p__61673){
var vec__61674 = p__61673;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61674,(0),null);
...
var G__61770 = cljs.core.next(element_vec);
var G__61771 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(element_vec));
element_vec = G__61770;
out = G__61771;
continue;
}
break;
 ...
 */
zprint.comment.fzprint_wrap_comments = (function zprint$comment$fzprint_wrap_comments(p__61677,style_vec){
var map__61678 = p__61677;
var map__61678__$1 = cljs.core.__destructure_map(map__61678);
var options = map__61678__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61678__$1,new cljs.core.Keyword(null,"width","width",-384071477));
...
var vec__61679 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(style_vec,index);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61679,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61679,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61679,(2),null);
...
var indent_index = zprint.comment.find_element_from_end((function (p1__61682_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__61682_SHARP_,new cljs.core.Keyword(null,"indent","indent",-148200125))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__61682_SHARP_,new cljs.core.Keyword(null,"newline","newline",1790071323))));
}),style_vec);
 ...
 */
zprint.comment.fzprint_inline_comments = (function zprint$comment$fzprint_inline_comments(p__61683,style_vec){
var map__61684 = p__61683;
var map__61684__$1 = cljs.core.__destructure_map(map__61684);
var options = map__61684__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61684__$1,new cljs.core.Keyword(null,"width","width",-384071477));
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(options))){
...
var vec__61699 = cljs.core.first(cvec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61699,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61699,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61699,(2),null);
var element = vec__61699;
var vec__61702 = cljs.core.second(cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61702,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61702,(1),null);
var ne = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61702,(2),null);
var nn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61702,(3),null);
var next_element = vec__61702;
var vec__61705 = last_out;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61705,(0),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61705,(1),null);
var le = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61705,(2),null);
...
var G__61777 = cljs.core.next(cvec);
var G__61778 = new_element;
var G__61779 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_element);
cvec = G__61777;
last_out = G__61778;
out = G__61779;
continue;
...
var vec__61712 = cljs.core.first(cvec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61712,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61712,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61712,(2),null);
var spaces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61712,(3),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61712,(4),null);
var element = vec__61712;
...
var G__61780 = cljs.core.next(cvec);
var G__61781 = (index + (1));
var G__61782 = null;
var G__61783 = (cljs.core.truth_(last_indent)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(current_seq,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [last_indent,index], null)):(function(){throw (new Error(["find-aligned-inline-comments a:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(index)].join('')))})());
var G__61784 = current_column;
var G__61785 = (0);
var G__61786 = out;
cvec = G__61780;
index = G__61781;
last_indent = G__61782;
current_seq = G__61783;
current_column = G__61784;
distance = G__61785;
out = G__61786;
continue;
} else {
var G__61787 = cljs.core.next(cvec);
var G__61788 = (index + (1));
var G__61789 = null;
var G__61790 = (cljs.core.truth_(last_indent)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [last_indent,index], null)], null):(function(){throw (new Error(["find-aligned-inline-comments b:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(index)].join('')))})());
var G__61791 = start_column;
var G__61792 = (0);
var G__61793 = (((cljs.core.count(current_seq) > (1)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,current_seq):out);
cvec = G__61787;
index = G__61788;
last_indent = G__61789;
current_seq = G__61790;
current_column = G__61791;
distance = G__61792;
out = G__61793;
continue;
}
...
var G__61794 = cljs.core.next(cvec);
var G__61795 = (index + (1));
var G__61796 = index;
var G__61797 = cljs.core.PersistentVector.EMPTY;
var G__61798 = (0);
var G__61799 = (0);
var G__61800 = (((cljs.core.count(current_seq) > (1)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,current_seq):out);
cvec = G__61794;
index = G__61795;
last_indent = G__61796;
current_seq = G__61797;
current_column = G__61798;
distance = G__61799;
out = G__61800;
continue;
} else {
var G__61801 = cljs.core.next(cvec);
var G__61802 = (index + (1));
var G__61803 = index;
var G__61804 = current_seq;
var G__61805 = current_column;
var G__61806 = (distance + (1));
var G__61807 = out;
cvec = G__61801;
index = G__61802;
last_indent = G__61803;
current_seq = G__61804;
current_column = G__61805;
distance = G__61806;
out = G__61807;
continue;
}
} else {
var G__61808 = cljs.core.next(cvec);
var G__61809 = (index + (1));
var G__61810 = last_indent;
var G__61811 = current_seq;
var G__61812 = current_column;
var G__61813 = distance;
var G__61814 = out;
cvec = G__61808;
index = G__61809;
last_indent = G__61810;
current_seq = G__61811;
current_column = G__61812;
distance = G__61813;
out = G__61814;
continue;
...
var vec__61718 = cljs.core.first(cvec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61718,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61718,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61718,(2),null);
var element = vec__61718;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(e,new cljs.core.Keyword(null,"comment-inline","comment-inline",712944405))){
var G__61815 = cljs.core.next(cvec);
var G__61816 = (index + (1));
var G__61817 = null;
var G__61818 = (cljs.core.truth_(last_indent)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(current_seq,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [last_indent,index], null)):(function(){throw (new Error(["find-consecutive-inline-comments:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(index)].join('')))})());
var G__61819 = out;
cvec = G__61815;
index = G__61816;
last_indent = G__61817;
current_seq = G__61818;
out = G__61819;
continue;
} else {
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(e,new cljs.core.Keyword(null,"indent","indent",-148200125))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(e,new cljs.core.Keyword(null,"newline","newline",1790071323))))){
var G__61820 = cljs.core.next(cvec);
var G__61821 = (index + (1));
var G__61822 = index;
var G__61823 = (cljs.core.truth_(last_indent)?cljs.core.PersistentVector.EMPTY:current_seq);
var G__61824 = (cljs.core.truth_(last_indent)?(((cljs.core.count(current_seq) > (1)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,current_seq):out):out);
cvec = G__61820;
index = G__61821;
last_indent = G__61822;
current_seq = G__61823;
out = G__61824;
continue;
} else {
var G__61825 = cljs.core.next(cvec);
var G__61826 = (index + (1));
var G__61827 = last_indent;
var G__61828 = current_seq;
var G__61829 = out;
cvec = G__61825;
index = G__61826;
last_indent = G__61827;
current_seq = G__61828;
out = G__61829;
continue;
 ...
 */
zprint.comment.comment_column = (function zprint$comment$comment_column(p__61722,style_vec){
var vec__61723 = p__61722;
var indent_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61723,(0),null);
var comment_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61723,(1),null);
...
var G__61832 = (index + (1));
var G__61833 = zprint.comment.loc_vec(column,cljs.core.nth.cljs$core$IFn$_invoke$arity$2(style_vec,index));
index = G__61832;
column = G__61833;
continue;
}
 ...
 */
zprint.comment.comment_vec_column = (function zprint$comment$comment_vec_column(style_vec,p__61726){
var vec__61727 = p__61726;
var indent_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61727,(0),null);
var inline_comment_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61727,(1),null);
var comment_vec = vec__61727;
...
var minimum_vec = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61730_SHARP_){
return ((cljs.core.second(p1__61730_SHARP_) - cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__61730_SHARP_,(2))) + (1));
}),comment_vec);
 ...
 *   at a new column.
 */
zprint.comment.change_start_column = (function zprint$comment$change_start_column(new_start_column,style_vec,p__61731){
var vec__61732 = p__61731;
var inline_comment_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61732,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61732,(1),null);
var spaces_before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61732,(2),null);
var comment_vec = vec__61732;
...
var vec__61735 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(style_vec,previous_element_index);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61735,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61735,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61735,(2),null);
var previous_element = vec__61735;
