...
var i_13731 = (self__.level + (1));
while(true){
if((i_13731 <= (new_level + (1)))){
(update[i_13731] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13733 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13733[i]));
} else {
x__$2.forward.push((((i < links_13733.length))?(links_13733[i]):null));
}

if((i < links_13733.length)){
(links_13733[i] = x__$2);
} else {
links_13733.push(x__$2);
}
...
var i_13735 = (0);
while(true){
if((i_13735 <= self__.level)){
var links_13736 = (update[i_13735]).forward;
if((x__$1 === (((i_13735 < links_13736.length))?(links_13736[i_13735]):null))){
(links_13736[i_13735] = (x__$1.forward[i_13735]));

var G__13738 = (i_13735 + (1));
i_13735 = G__13738;
continue;
} else {
var G__13739 = (i_13735 + (1));
i_13735 = G__13739;
continue;
}
} else {
