...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__56850_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__56850_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__56850_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__56853){
var vec__56854 = p__56853;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56854,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56854,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__56864,s,color,element,idx){
var map__56865 = p__56864;
var map__56865__$1 = cljs.core.__destructure_map(map__56865);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56865__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56865__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56865__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__56872 = (function (){var or__5045__auto__ = color;
...
var fexpr__56871 = (function (){var G__56873 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__56873) : style_map.call(null,G__56873));
})();
return (fexpr__56871.cljs$core$IFn$_invoke$arity$1 ? fexpr__56871.cljs$core$IFn$_invoke$arity$1(G__56872) : fexpr__56871.call(null,G__56872));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__56881){
var vec__56882 = p__56881;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56882,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56882,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56882,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__56887){
var vec__56888 = p__56887;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56888,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56888,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56888,(2),null);
...
var G__57007 = cljs.core.next(ssv);
var G__57008 = (this_ssv == null);
var G__57009 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
...
var vec__56905 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56905,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56905,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56905,(2),null);
...
var G__57011 = cljs.core.next(remaining_cvec);
var G__57012 = new_idx;
var G__57013 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__57011;
idx = G__57012;
out = G__57013;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__56920,cursor_vec){
var vec__56921 = p__56920;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56921,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56921,(1),null);
var focus_vec = vec__56921;
...
var vec__56924 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56924,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56924,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__56929){
var vec__56930 = p__56929;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56930,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56930,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__56939,existing_count){
var vec__56940 = p__56939;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56940,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56940,(1),null);
...
return cljs.core.filterv((function (p1__56936_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__56936_SHARP_))));
...
var vec__56981 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56981,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56981,(1),null);
var cvec_element = vec__56981;
if((cvec_element == null)){
var G__57022 = cljs.core.next(cvec_nl);
var G__57023 = (idx + (1));
var G__57024 = start;
var G__57025 = out;
cvec_nl = G__57022;
...
var G__57026 = cljs.core.next(cvec_nl);
var G__57027 = (idx + (1));
var G__57028 = idx;
var G__57029 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__57026;
idx = G__57027;
start = G__57028;
out = G__57029;
...
var G__57030 = cljs.core.next(cvec_nl);
var G__57031 = (idx + (1));
var G__57032 = (idx + (1));
var G__57033 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__57030;
idx = G__57031;
start = G__57032;
out = G__57033;
...
var G__57034 = cljs.core.next(cvec_nl);
var G__57035 = (idx + (1));
var G__57036 = idx;
var G__57037 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__57034;
idx = G__57035;
start = G__57036;
out = G__57037;
...
var G__57038 = cljs.core.next(cvec_nl);
var G__57039 = (idx + (1));
var G__57040 = start;
var G__57041 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__57038;
idx = G__57039;
start = G__57040;
out = G__57041;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__56985_SHARP_,p2__56984_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__56984_SHARP_)){
return cljs.core.reduced(p1__56985_SHARP_);
} else {
return (p1__56985_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__56986,p__56987){
var vec__56988 = p__56986;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56988,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56988,(1),null);
var vec__56991 = p__56987;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56991,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56991,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__57001,cvec,focus_vec){
var map__57002 = p__57001;
var map__57002__$1 = cljs.core.__destructure_map(map__57002);
var options = map__57002__$1;
var map__57003 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57002__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__57003__$1 = cljs.core.__destructure_map(map__57003);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57003__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57003__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57003__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56996_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__56996_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
