...
var o17092 = temp__5802__auto__;
var temp__5802__auto____$1 = (o17092["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o17093 = temp__5802__auto____$1;
return (o17093["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__16214__auto__ = f;
return (o__16214__auto__["toString"]).call(o__16214__auto__);
} else {
return "";
}
}catch (e17096){var _ = e17096;
return "";
}});
...
try{var o__16214__auto___17540 = t;
(o__16214__auto___17540["cljs$lang$ctorPrWriter"]).call(o__16214__auto___17540,t,writer);
}catch (e17097){var __17541 = e17097;
}
...
var char_code = (function (){var o__16214__auto__ = (new String(char$));
return (o__16214__auto__["charCodeAt"]).call(o__16214__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__16214__auto__ = String;
return (o__16214__auto__["fromCharCode"]).call(o__16214__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__17109 = num_code;
switch (G__17109) {
case (1):
return (185);
...
var o__16214__auto__ = String;
return (o__16214__auto__["fromCharCode"]).call(o__16214__auto__,superscript_code);
});
/**
...
}catch (e17122){var _e__16240__auto__ = e17122;
return false;
}})())){
...
var vec__17124 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17124,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__17147){
var vec__17148 = p__17147;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17148,(0),null);
...
var G__17556 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__17557 = cljs.core.butlast(remaining_tokens);
name_tokens = G__17556;
remaining_tokens = G__17557;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq17145){
var G__17146 = cljs.core.first(seq17145);
var seq17145__$1 = cljs.core.next(seq17145);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17146,seq17145__$1);
}));
...
var vec__17160 = cljs.core.split_with((function (p1__17159_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__17159_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17160,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17160,(1),null);
...
var vec__17180 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17180,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17180,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__17563 = cljs.core.rest(remaining_tokens);
var G__17564 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__17563;
name_tokens = G__17564;
continue;
} else {
...
var vec__17213 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17213,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17213,(1),null);
var vec__17216 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17216,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17216,(1),null);
var vec__17219 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17219,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17219,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17219,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17219,(3),null);
...
var vec__17230 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17230,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17230,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17230,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17230,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17230,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17230,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__17240 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17240,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17240,(1),null);
var vec__17245 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17245,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17245,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__17249 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__17249) : devtools.munging.parse_fn_info_deep.call(null,G__17249));
})()));
}
} else {
return fn_info;
...
var G__17572 = (arity + (1));
var G__17573 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__17294){
var vec__17295 = p__17294;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17295,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17295,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17325_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__17325_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17326_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__17326_SHARP_);
}),sorted_infos);
...
var i__5770__auto___17582 = (0);
while(true){
if((i__5770__auto___17582 < len__5769__auto___17581)){
args__5775__auto__.push((arguments[i__5770__auto___17582]));

var G__17583 = (i__5770__auto___17582 + (1));
i__5770__auto___17582 = G__17583;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__17351){
var vec__17352 = p__17351;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17352,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq17347){
var G__17349 = cljs.core.first(seq17347);
var seq17347__$1 = cljs.core.next(seq17347);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17349,seq17347__$1);
}));
...
var map__17395 = options;
var map__17395__$1 = cljs.core.__destructure_map(map__17395);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17395__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17395__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17395__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17395__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__17396 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17396,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17396,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17396,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17396,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17396,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17396,(5),null);
...
var o__16214__auto__ = f;
return (o__16214__auto__["getBasis"]).call(o__16214__auto__);
});
/**
...
}catch (e17417){var _e__16240__auto__ = e17417;
...
var G__17588 = (obj[cljs.core.first(path)]);
var G__17589 = cljs.core.rest(path);
obj = G__17588;
path = G__17589;
continue;
} else {
...
var _STAR_ = (function (accum,p__17462){
var vec__17463 = p__17462;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17463,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17463,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__17502){
var vec__17503 = p__17502;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17503,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17503,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17503,(2),null);
...
var post_process = (function (p__17513){
var vec__17514 = p__17513;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17514,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17514,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17511_SHARP_){
return (obj[cljs.core.first(p1__17511_SHARP_)]);
}),sorted_matches);
