...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57966,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57966,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57975){
var vec__57976 = p__57975;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57976,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57976,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57965){
var self__ = this;
var G__57965__$1 = this;
return (new cljs.core.RecordIter((0),G__57965__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57967,other57968){
var self__ = this;
var this57967__$1 = this;
return (((!((other57968 == null)))) && ((((this57967__$1.constructor === other57968.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57967__$1.children,other57968.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57967__$1.__extmap,other57968.__extmap)))))));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57966){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k57966);

}
}));

(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57965){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57997 = cljs.core.keyword_identical_QMARK_;
var expr__57998 = k__5352__auto__;
if(cljs.core.truth_((pred__57997.cljs$core$IFn$_invoke$arity$2 ? pred__57997.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__57998) : pred__57997.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__57998)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__57965,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57965),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57965){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__57965,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__57970){
var extmap__5385__auto__ = (function (){var G__58006 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__57970,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__57970)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58006);
} else {
return G__58006;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__57970),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__58022 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__58022;
continue;
}
break;
