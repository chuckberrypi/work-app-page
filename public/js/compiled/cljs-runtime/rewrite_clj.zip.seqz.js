...
var G__59637 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__59637__$1 = (((G__59637 == null))?null:cljs.core.iterate((function (loc){
...
var G__59637__$2 = (((G__59637__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__59637__$1));
var G__59637__$3 = (((G__59637__$2 == null))?null:cljs.core.last(G__59637__$2));
if((G__59637__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__59637__$3);
}
} else {
return zloc;
}
...
var G__59674 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__59675 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__59674;
parent = G__59675;
continue;
} else {
var G__59676 = rewrite_clj.zip.move.right(zloc_map_value);
var G__59677 = parent;
loc = G__59676;
parent = G__59677;
continue;
...
var G__59678 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__59679 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__59678;
parent = G__59679;
continue;
} else {
var G__59681 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__59682 = parent;
loc = G__59681;
parent = G__59682;
continue;
...
var G__59658 = zloc;
var G__59658__$1 = (((G__59658 == null))?null:rewrite_clj.zip.move.down(G__59658));
var G__59658__$2 = (((G__59658__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__59658__$1,k));
if((G__59658__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__59658__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__59661 = zloc;
var G__59661__$1 = (((G__59661 == null))?null:rewrite_clj.zip.move.down(G__59661));
var G__59661__$2 = (((G__59661__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__59661__$1));
var G__59661__$3 = (((G__59661__$2 == null))?null:rewrite_clj.zip.move.down(G__59661__$2));
var G__59661__$4 = (((G__59661__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__59661__$3,k));
if((G__59661__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__59661__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__59663 = rewrite_clj.zip.move.down(zloc);
var G__59663__$1 = (((G__59663 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__59663));
if((G__59663__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__59663__$1);
}
})(),k);
