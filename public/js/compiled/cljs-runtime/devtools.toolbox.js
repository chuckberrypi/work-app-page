...
*/
devtools.toolbox.t_devtools$toolbox19061 = (function (obj,header,style,tag,meta19062){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
(devtools.toolbox.t_devtools$toolbox19061.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19063,meta19062__$1){
var self__ = this;
var _19063__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox19061(self__.obj,self__.header,self__.style,self__.tag,meta19062__$1));
}));

(devtools.toolbox.t_devtools$toolbox19061.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19063){
var self__ = this;
var _19063__$1 = this;
return self__.meta19062;
}));

(devtools.toolbox.t_devtools$toolbox19061.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox19061.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox19061.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox19061.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox19061.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta19062","meta19062",-1051613276,null)], null);
}));

(devtools.toolbox.t_devtools$toolbox19061.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox19061.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox19061");

(devtools.toolbox.t_devtools$toolbox19061.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"devtools.toolbox/t_devtools$toolbox19061");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox19061.
 */
devtools.toolbox.__GT_t_devtools$toolbox19061 = (function devtools$toolbox$__GT_t_devtools$toolbox19061(obj,header,style,tag,meta19062){
return (new devtools.toolbox.t_devtools$toolbox19061(obj,header,style,tag,meta19062));
});
...
return (new devtools.toolbox.t_devtools$toolbox19061(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
