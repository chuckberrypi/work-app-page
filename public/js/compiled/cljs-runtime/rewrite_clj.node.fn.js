...
var sym_seq = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__57102(s__57103){
...
var i = cljs.core._nth(c__5521__auto__,i__57104);
...
cljs.core.chunk_append(b__57105,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__57293 = (i__57104 + (1));
i__57104 = G__57293;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57105),rewrite_clj$node$fn$fn_walk_$_iter__57102(cljs.core.chunk_rest(s__57103__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57105),null);
}
} else {
var i = cljs.core.first(s__57103__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__57102(cljs.core.rest(s__57103__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__57092_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__57092_SHARP_);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return p1__57092_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57150,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57150,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57206){
var vec__57207 = p__57206;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57207,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57207,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57149){
var self__ = this;
var G__57149__$1 = this;
return (new cljs.core.RecordIter((0),G__57149__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57151,other57152){
var self__ = this;
var this57151__$1 = this;
return (((!((other57152 == null)))) && ((((this57151__$1.constructor === other57152.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57151__$1.children,other57152.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57151__$1.__extmap,other57152.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57150){
var self__ = this;
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57149){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57253 = cljs.core.keyword_identical_QMARK_;
var expr__57254 = k__5352__auto__;
if(cljs.core.truth_((pred__57253.cljs$core$IFn$_invoke$arity$2 ? pred__57253.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__57254) : pred__57253.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__57254)))){
return (new rewrite_clj.node.fn.FnNode(G__57149,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57149),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57149){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__57149,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__57155){
var extmap__5385__auto__ = (function (){var G__57268 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__57155,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__57155)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57268);
} else {
return G__57268;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__57155),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
