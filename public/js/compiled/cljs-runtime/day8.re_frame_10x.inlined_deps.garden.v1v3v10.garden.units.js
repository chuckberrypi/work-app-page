 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__54713,right){
var map__54714 = p__54713;
var map__54714__$1 = cljs.core.__destructure_map(map__54714);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54714__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54714__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__54715 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54715,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54715,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54715,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54718__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__54719 = u(y);
var map__54719__$1 = cljs.core.__destructure_map(map__54719);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54719__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__54727__delegate = function (x,y,more){
...
var G__54727 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__54728__i = 0, G__54728__a = new Array(arguments.length -  2);
while (G__54728__i < G__54728__a.length) {G__54728__a[G__54728__i] = arguments[G__54728__i + 2]; ++G__54728__i;}
  more = new cljs.core.IndexedSeq(G__54728__a,0,null);
} 
return G__54727__delegate.call(this,x,y,more);};
G__54727.cljs$lang$maxFixedArity = 2;
G__54727.cljs$lang$applyTo = (function (arglist__54729){
var x = cljs.core.first(arglist__54729);
arglist__54729 = cljs.core.next(arglist__54729);
var y = cljs.core.first(arglist__54729);
var more = cljs.core.rest(arglist__54729);
return G__54727__delegate(x,y,more);
});
G__54727.cljs$core$IFn$_invoke$arity$variadic = G__54727__delegate;
return G__54727;
})()
;
...
var G__54730 = null;
if (arguments.length > 2) {
var G__54731__i = 0, G__54731__a = new Array(arguments.length -  2);
while (G__54731__i < G__54731__a.length) {G__54731__a[G__54731__i] = arguments[G__54731__i + 2]; ++G__54731__i;}
G__54730 = new cljs.core.IndexedSeq(G__54731__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__54730);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54720__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__54721 = u(y);
var map__54721__$1 = cljs.core.__destructure_map(map__54721);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54721__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__54734__delegate = function (x,y,more){
...
var G__54734 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__54735__i = 0, G__54735__a = new Array(arguments.length -  2);
while (G__54735__i < G__54735__a.length) {G__54735__a[G__54735__i] = arguments[G__54735__i + 2]; ++G__54735__i;}
  more = new cljs.core.IndexedSeq(G__54735__a,0,null);
} 
return G__54734__delegate.call(this,x,y,more);};
G__54734.cljs$lang$maxFixedArity = 2;
G__54734.cljs$lang$applyTo = (function (arglist__54736){
var x = cljs.core.first(arglist__54736);
arglist__54736 = cljs.core.next(arglist__54736);
var y = cljs.core.first(arglist__54736);
var more = cljs.core.rest(arglist__54736);
return G__54734__delegate(x,y,more);
});
...
var G__54737 = null;
if (arguments.length > 2) {
var G__54738__i = 0, G__54738__a = new Array(arguments.length -  2);
while (G__54738__i < G__54738__a.length) {G__54738__a[G__54738__i] = arguments[G__54738__i + 2]; ++G__54738__i;}
G__54737 = new cljs.core.IndexedSeq(G__54738__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__54737);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54722__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__54723 = u(y);
var map__54723__$1 = cljs.core.__destructure_map(map__54723);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54723__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__54739__delegate = function (x,y,more){
...
var G__54739 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__54740__i = 0, G__54740__a = new Array(arguments.length -  2);
while (G__54740__i < G__54740__a.length) {G__54740__a[G__54740__i] = arguments[G__54740__i + 2]; ++G__54740__i;}
  more = new cljs.core.IndexedSeq(G__54740__a,0,null);
} 
return G__54739__delegate.call(this,x,y,more);};
G__54739.cljs$lang$maxFixedArity = 2;
G__54739.cljs$lang$applyTo = (function (arglist__54741){
var x = cljs.core.first(arglist__54741);
arglist__54741 = cljs.core.next(arglist__54741);
var y = cljs.core.first(arglist__54741);
var more = cljs.core.rest(arglist__54741);
return G__54739__delegate(x,y,more);
});
...
var G__54742 = null;
if (arguments.length > 2) {
var G__54743__i = 0, G__54743__a = new Array(arguments.length -  2);
while (G__54743__i < G__54743__a.length) {G__54743__a[G__54743__i] = arguments[G__54743__i + 2]; ++G__54743__i;}
G__54742 = new cljs.core.IndexedSeq(G__54743__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__54742);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54724__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__54725 = u(y);
var map__54725__$1 = cljs.core.__destructure_map(map__54725);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54725__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__54744__delegate = function (x,y,more){
...
var G__54744 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__54745__i = 0, G__54745__a = new Array(arguments.length -  2);
while (G__54745__i < G__54745__a.length) {G__54745__a[G__54745__i] = arguments[G__54745__i + 2]; ++G__54745__i;}
  more = new cljs.core.IndexedSeq(G__54745__a,0,null);
} 
return G__54744__delegate.call(this,x,y,more);};
G__54744.cljs$lang$maxFixedArity = 2;
G__54744.cljs$lang$applyTo = (function (arglist__54746){
var x = cljs.core.first(arglist__54746);
arglist__54746 = cljs.core.next(arglist__54746);
var y = cljs.core.first(arglist__54746);
var more = cljs.core.rest(arglist__54746);
return G__54744__delegate(x,y,more);
});
...
var G__54747 = null;
if (arguments.length > 2) {
var G__54748__i = 0, G__54748__a = new Array(arguments.length -  2);
while (G__54748__i < G__54748__a.length) {G__54748__a[G__54748__i] = arguments[G__54748__i + 2]; ++G__54748__i;}
G__54747 = new cljs.core.IndexedSeq(G__54748__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__54747);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
