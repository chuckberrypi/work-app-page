...
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__36813_36860) : reporter_fn.call(null,G__36813_36860));
...
var vec__36820 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36820,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36820,(1),null);
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__36826){
var map__36827 = p__36826;
var map__36827__$1 = cljs.core.__destructure_map(map__36827);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36827__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36827__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36827__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__36828 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36828,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36828,(1),null);
...
var size = first__36844;
var rest_size_seq = seq__36843__$1;
var vec__36845 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36845,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36845,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq36823){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36824,G__36825,seq36823__$2);
}));
...
var map__36850 = smallest;
var map__36850__$1 = cljs.core.__destructure_map(map__36850);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36850__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__36868 = tail;
var G__36869 = current_smallest;
var G__36870 = (total_nodes_visited + (1));
var G__36871 = depth;
nodes = G__36868;
current_smallest = G__36869;
total_nodes_visited = G__36870;
depth = G__36871;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__36853_36872 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__36853_36872) : reporter_fn.call(null,G__36853_36872));

var temp__5802__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5802__auto__){
var children = temp__5802__auto__;
var G__36873 = children;
var G__36874 = new_smallest;
var G__36875 = (total_nodes_visited + (1));
var G__36876 = (depth + (1));
nodes = G__36873;
current_smallest = G__36874;
total_nodes_visited = G__36875;
depth = G__36876;
continue;
} else {
var G__36877 = tail;
var G__36878 = new_smallest;
var G__36879 = (total_nodes_visited + (1));
var G__36880 = depth;
nodes = G__36877;
current_smallest = G__36878;
total_nodes_visited = G__36879;
depth = G__36880;
continue;
}
}
...
var G__36856_36881 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__36856_36881) : reporter_fn.call(null,G__36856_36881));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__36854_SHARP_){
var G__36857 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__36854_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__36857) : reporter_fn.call(null,G__36857));
}));
var G__36858_36882 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__36858_36882) : reporter_fn.call(null,G__36858_36882));
