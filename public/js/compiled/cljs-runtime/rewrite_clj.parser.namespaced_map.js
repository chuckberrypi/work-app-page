...
var G__58101 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(nodes,n);
nodes = G__58101;
continue;
} else {
...
var vec__58082 = rewrite_clj.parser.namespaced_map.parse_to_next_elem(reader,read_next);
var whitespace_nodes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58082,(0),null);
var map_node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58082,(1),null);
