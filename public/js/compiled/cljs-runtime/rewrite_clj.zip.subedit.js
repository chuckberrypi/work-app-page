...
var zloc_SINGLEQUOTE_ = (function (){var G__59599 = zloc;
var G__59599__$1 = (((G__59599 == null))?null:rewrite_clj.custom_zipper.core.node(G__59599));
if((G__59599__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.edn_STAR_.cljs$core$IFn$_invoke$arity$2(G__59599__$1,rewrite_clj.zip.options.get_opts(zloc));
}
})();
...
var zloc_SINGLEQUOTE_ = (function (){var G__59600 = rewrite_clj.zip.subedit.subzip(zloc);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__59600) : f.call(null,G__59600));
})();
if((!((zloc_SINGLEQUOTE_ == null)))){
} else {
