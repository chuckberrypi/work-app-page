...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75970_SHARP_){
return ((day8.re_frame_10x.tools.metamorphic.request_animation_frame_QMARK_(p1__75970_SHARP_)) || (day8.re_frame_10x.tools.metamorphic.request_animation_frame_end_QMARK_(p1__75970_SHARP_)));
}),traces);
})], 0));
...
var len__5769__auto___76021 = arguments.length;
var i__5770__auto___76022 = (0);
while(true){
if((i__5770__auto___76022 < len__5769__auto___76021)){
args_arr__5794__auto__.push((arguments[i__5770__auto___76022]));

var G__76023 = (i__5770__auto___76022 + (1));
i__5770__auto___76022 = G__76023;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$applyTo = (function (seq75973){
var G__75974 = cljs.core.first(seq75973);
var seq75973__$1 = cljs.core.next(seq75973);
var G__75975 = cljs.core.first(seq75973__$1);
var seq75973__$2 = cljs.core.next(seq75973__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__75974,G__75975,seq75973__$2);
}));

(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$maxFixedArity = (2));

day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-time","day8.re-frame-10x.panels.timing.subs/animation-frame-time",1191520772),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-traces","day8.re-frame-10x.panels.timing.subs/animation-frame-traces",-1778771106)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.traces.subs","filtered-by-epoch-always","day8.re-frame-10x.panels.traces.subs/filtered-by-epoch-always",-1807060768)], null),(function (p__76001,p__76002){
var vec__76007 = p__76001;
var af_start_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76007,(0),null);
var epoch_traces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76007,(1),null);
var vec__76010 = p__76002;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76010,(0),null);
var frame_number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76010,(1),null);
...
var vec__76015 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(frame_pairs,(frame_number - (1)));
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76015,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76015,(1),null);
...
var map__76018 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(match,new cljs.core.Keyword(null,"timing","timing",-1849225195));
var map__76018__$1 = cljs.core.__destructure_map(map__76018);
var event_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76018__$1,new cljs.core.Keyword("re-frame","event-time","re-frame/event-time",-1349372188));
var event_handler_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76018__$1,new cljs.core.Keyword("re-frame","event-handler-time","re-frame/event-handler-time",1278050644));
var event_dofx_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76018__$1,new cljs.core.Keyword("re-frame","event-dofx-time","re-frame/event-dofx-time",650880716));
var event_run_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76018__$1,new cljs.core.Keyword("re-frame","event-run-time","re-frame/event-run-time",1941554897));
