...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k36809,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k36809,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__36816){
var vec__36817 = p__36816;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36817,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36817,(1),null);
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__36808){
var self__ = this;
var G__36808__$1 = this;
return (new cljs.core.RecordIter((0),G__36808__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this36810,other36811){
var self__ = this;
var this36810__$1 = this;
return (((!((other36811 == null)))) && ((((this36810__$1.constructor === other36811.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36810__$1.error,other36811.error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36810__$1.__extmap,other36811.__extmap)))))));
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k36809){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k36809);

}
}));

(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__36808){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__36838 = cljs.core.keyword_identical_QMARK_;
var expr__36839 = k__5352__auto__;
if(cljs.core.truth_((pred__36838.cljs$core$IFn$_invoke$arity$2 ? pred__36838.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"error","error",-978969032),expr__36839) : pred__36838.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36839)))){
return (new clojure.test.check.properties.ErrorResult(G__36808,self__.__meta,self__.__extmap,null));
} else {
return (new clojure.test.check.properties.ErrorResult(self__.error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__36808),null));
}
}));
...
(clojure.test.check.properties.ErrorResult.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__36808){
var self__ = this;
var this__5342__auto____$1 = this;
return (new clojure.test.check.properties.ErrorResult(self__.error,G__36808,self__.__extmap,self__.__hash));
}));
 ...
 */
clojure.test.check.properties.map__GT_ErrorResult = (function clojure$test$check$properties$map__GT_ErrorResult(G__36812){
var extmap__5385__auto__ = (function (){var G__36849 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__36812,new cljs.core.Keyword(null,"error","error",-978969032));
if(cljs.core.record_QMARK_(G__36812)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__36849);
} else {
return G__36849;
}
})();
return (new clojure.test.check.properties.ErrorResult(new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(G__36812),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
