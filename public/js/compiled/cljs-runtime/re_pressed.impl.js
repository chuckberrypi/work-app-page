...
return cljs.core.every_QMARK_((function (p__28894){
var vec__28895 = p__28894;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28895,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28895,(1),null);
...
var ns_keyword = re_pressed.impl.__GT_ns_keyword(event_type);
return (function re_pressed$impl$__GT_set_key_BANG__$_set_key_BANG_(p__28923,p__28924){
var map__28925 = p__28923;
var map__28925__$1 = cljs.core.__destructure_map(map__28925);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28925__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__28926 = p__28924;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28926,(0),null);
var key_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28926,(1),null);
...
var ns_keyword = re_pressed.impl.__GT_ns_keyword(event_type);
return (function re_pressed$impl$__GT_clear_keys_BANG__$_clear_keys_BANG_(p__28930,p__28931){
var map__28932 = p__28930;
var map__28932__$1 = cljs.core.__destructure_map(map__28932);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28932__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__28937 = p__28931;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28937,(0),null);
var key_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28937,(1),null);
...
re_pressed.impl.prevent_default_keys_BANG_ = (function re_pressed$impl$prevent_default_keys_BANG_(_,p__28948){
var vec__28949 = p__28948;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28949,(0),null);
...
re_frame.core.reg_fx(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1([re_pressed.impl.ns_root,"keyboard-event"].join('')),(function (p__28966){
var map__28967 = p__28966;
var map__28967__$1 = cljs.core.__destructure_map(map__28967);
var event_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28967__$1,new cljs.core.Keyword(null,"event-type","event-type",319722813));
var arguments$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28967__$1,new cljs.core.Keyword(null,"arguments","arguments",-1182834456));
...
var map__28968 = arguments$;
var map__28968__$1 = cljs.core.__destructure_map(map__28968);
var clear_on_success_event_match = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28968__$1,new cljs.core.Keyword(null,"clear-on-success-event-match","clear-on-success-event-match",769810234));
...
var always_listen_QMARK_ = cljs.core.some((function (p1__28960_SHARP_){
return re_pressed.impl.is_key_QMARK_(hit_key,p1__28960_SHARP_);
}),always_listen_keys);
...
return cljs.core.every_QMARK_(cljs.core.true_QMARK_,cljs.core.mapv.cljs$core$IFn$_invoke$arity$3((function (p1__28961_SHARP_,p2__28962_SHARP_){
return re_pressed.impl.is_key_QMARK_(p1__28961_SHARP_,p2__28962_SHARP_);
...
var check_events = cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function re_pressed$impl$iter__28992(s__28993){
...
var c__5521__auto__ = cljs.core.chunk_first(s__28993__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__28995 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__28994 = (0);
while(true){
if((i__28994 < size__5522__auto__)){
var vec__29007 = cljs.core._nth(c__5521__auto__,i__28994);
...
var trigger_event = first__29009;
var ks = seq__29008__$1;
cljs.core.chunk_append(b__28995,(function (){var triggered_QMARK_ = cljs.core.some(is_key_sequence_QMARK_,ks);
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[trigger_event,triggered_QMARK_],null));
})());

var G__29042 = (i__28994 + (1));
i__28994 = G__29042;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28995),re_pressed$impl$iter__28992(cljs.core.chunk_rest(s__28993__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28995),null);
}
} else {
var vec__29026 = cljs.core.first(s__28993__$2);
...
var trigger_event = first__29028;
var ks = seq__29027__$1;
return cljs.core.cons((function (){var triggered_QMARK_ = cljs.core.some(is_key_sequence_QMARK_,ks);
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[trigger_event,triggered_QMARK_],null));
})(),re_pressed$impl$iter__28992(cljs.core.rest(s__28993__$2)));
}
} else {
return null;
}
...
var vec__28989 = (function (){var G__29029 = check_events;
var G__29029__$1 = (((G__29029 == null))?null:cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__28964_SHARP_){
return cljs.core.second(p1__28964_SHARP_) === true;
}),G__29029));
if((G__29029__$1 == null)){
return null;
} else {
return cljs.core.first(G__29029__$1);
}
})();
var triggered_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28989,(0),null);
var event_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28989,(1),null);
var clear_QMARK_ = cljs.core.some(is_key_sequence_QMARK_,clear_keys);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("keydown",event_type)){
var prevent_default_keys_29043 = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ns_keyword("-prevent-default-keys")], null)));
var prevent_default_QMARK__29044 = cljs.core.some((function (p1__28965_SHARP_){
return re_pressed.impl.is_key_QMARK_(recent_key,p1__28965_SHARP_);
}),prevent_default_keys_29043);
if(cljs.core.truth_(prevent_default_QMARK__29044)){
