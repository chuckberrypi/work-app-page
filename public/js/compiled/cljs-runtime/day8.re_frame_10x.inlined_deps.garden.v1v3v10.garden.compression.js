 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__53011){
var vec__53012 = p__53011;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53012,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53012,(1),null);
return (function (s){
...
var i__5770__auto___53040 = (0);
while(true){
if((i__5770__auto___53040 < len__5769__auto___53038)){
args__5775__auto__.push((arguments[i__5770__auto___53040]));

var G__53041 = (i__5770__auto___53040 + (1));
i__5770__auto___53040 = G__53041;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__53019_SHARP_){
return (p1__53019_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__53019_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__53019_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq53020){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq53020));
}));
...
var map__53031 = temp__5802__auto__;
var map__53031__$1 = cljs.core.__destructure_map(map__53031);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53031__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53031__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53031__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__53048 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__53049 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__53036 = tag;
