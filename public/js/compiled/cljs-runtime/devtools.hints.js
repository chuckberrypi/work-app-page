...
var map__17509 = top_item;
var map__17509__$1 = cljs.core.__destructure_map(map__17509);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17509__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17509__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17509__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e17507){var _e = e17507;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___17543 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___17543)){
var seen_errors_17544 = temp__5802__auto___17543;
if(cljs.core.truth_(seen_errors_17544.has(self))){
} else {
seen_errors_17544.add(self);

var temp__5804__auto___17545 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___17545)){
var sense_17546 = temp__5804__auto___17545;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_17546)].join(''));
} else {
}
}
} else {
