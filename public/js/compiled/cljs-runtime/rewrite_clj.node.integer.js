...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57118,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57118,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57154){
var vec__57156 = p__57154;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57156,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57156,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57117){
var self__ = this;
var G__57117__$1 = this;
return (new cljs.core.RecordIter((0),G__57117__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var abs_value = (function (){var G__57232 = self__.value;
if((self__.value < (0))){
return (- G__57232);
} else {
return G__57232;
...
var prefix = (function (){var G__57233 = cljs.core.long$(self__.base);
switch (G__57233) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57118){
var self__ = this;
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57117){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57260 = cljs.core.keyword_identical_QMARK_;
var expr__57261 = k__5352__auto__;
if(cljs.core.truth_((pred__57260.cljs$core$IFn$_invoke$arity$2 ? pred__57260.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__57261) : pred__57260.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__57261)))){
return (new rewrite_clj.node.integer.IntNode(G__57117,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57260.cljs$core$IFn$_invoke$arity$2 ? pred__57260.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__57261) : pred__57260.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__57261)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__57117,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57117),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57117){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__57117,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__57124){
var extmap__5385__auto__ = (function (){var G__57282 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57124,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
if(cljs.core.record_QMARK_(G__57124)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57282);
} else {
return G__57282;
}
})();
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__57124),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__57124),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
