...
return [(function (){var pred__52513 = cljs.core.instance_QMARK_;
var expr__52514 = reactive_val;
if(cljs.core.truth_((pred__52513.cljs$core$IFn$_invoke$arity$2 ? pred__52513.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__52514) : pred__52513.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__52514)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52513.cljs$core$IFn$_invoke$arity$2 ? pred__52513.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__52514) : pred__52513.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__52514)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52513.cljs$core$IFn$_invoke$arity$2 ? pred__52513.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__52514) : pred__52513.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__52514)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52513.cljs$core$IFn$_invoke$arity$2 ? pred__52513.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__52514) : pred__52513.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__52514)))){
return "tr";
} else {
return "other";
}
