...
return rewrite_clj.zip.walk.postwalk.cljs$core$IFn$_invoke$arity$3(zloc,(function (p1__59690_SHARP_){
var G__59691 = rewrite_clj.custom_zipper.core.node(p1__59690_SHARP_);
if((!((G__59691 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__59691.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__59691.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(rewrite_clj.node.protocols.MapQualifiable,G__59691);
} else {
return false;
}
}
