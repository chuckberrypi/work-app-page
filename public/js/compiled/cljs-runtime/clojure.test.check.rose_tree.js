...
return cljs.core.cons(cljs.core.first(s),(function (){var G__31650 = (n - (1));
var G__31651 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__31650,G__31651) : clojure.test.check.rose_tree.exclude_nth.call(null,G__31650,G__31651));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__31654 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__31654) : f.call(null,G__31654));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31653_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__31653_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__31653_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31655_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__31655_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__31655_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__31656_SHARP_){
var G__31657 = clojure.test.check.rose_tree.root(p1__31656_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__31657) : pred.call(null,G__31657));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5523__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__31658(s__31659){
return (new cljs.core.LazySeq(null,(function (){
var s__31659__$1 = s__31659;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__31659__$1);
if(temp__5804__auto__){
var xs__6360__auto__ = temp__5804__auto__;
var vec__31667 = cljs.core.first(xs__6360__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31667,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31667,(1),null);
var iterys__5519__auto__ = ((function (s__31659__$1,vec__31667,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__31658_$_iter__31660(s__31661){
return (new cljs.core.LazySeq(null,((function (s__31659__$1,vec__31667,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function (){
var s__31661__$1 = s__31661;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__31661__$1);
if(temp__5804__auto____$1){
var s__31661__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__31661__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__31661__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__31663 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__31662 = (0);
while(true){
if((i__31662 < size__5522__auto__)){
var child = cljs.core._nth(c__5521__auto__,i__31662);
cljs.core.chunk_append(b__31663,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__31705 = (i__31662 + (1));
i__31662 = G__31705;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31663),clojure$test$check$rose_tree$permutations_$_iter__31658_$_iter__31660(cljs.core.chunk_rest(s__31661__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31663),null);
}
} else {
var child = cljs.core.first(s__31661__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__31658_$_iter__31660(cljs.core.rest(s__31661__$2)));
}
} else {
return null;
}
...
});})(s__31659__$1,vec__31667,rose,index,xs__6360__auto__,temp__5804__auto__))
,null,null));
});})(s__31659__$1,vec__31667,rose,index,xs__6360__auto__,temp__5804__auto__))
;
var fs__5520__auto__ = cljs.core.seq(iterys__5519__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5520__auto__,clojure$test$check$rose_tree$permutations_$_iter__31658(cljs.core.rest(s__31659__$1)));
} else {
var G__31708 = cljs.core.rest(s__31659__$1);
s__31659__$1 = G__31708;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31671_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__31671_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__31671_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31681_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__31681_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__31681_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__31682 = f;
var G__31683 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__31682,G__31683) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__31682,G__31683));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__31685 = f;
var G__31686 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__31685,G__31686) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__31685,G__31686));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
