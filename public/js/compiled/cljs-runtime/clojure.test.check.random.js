...
var clojure$test$check$random$IRandom$rand_long$dyn_31712 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_31712(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_31713 = (function (rng){
var x__5393__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_31713(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_31714 = (function (rng){
var x__5393__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_31714(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_31715 = (function (rng,n){
var x__5393__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_31715(rng,n);
}
});
...
var G__31672 = z;
if(((24) > (function (){var G__31679 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__31679) : clojure.test.check.random.longs.bit_count.call(null,G__31679));
})())){
return clojure.test.check.random.longs.bit_xor(G__31672,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__31672;
}
});
...
var G__31741 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__31742 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__31741;
ret = G__31742;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__31699){
var map__31700 = p__31699;
var map__31700__$1 = cljs.core.__destructure_map(map__31700);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31700__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__31701 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31701,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31701,(1),null);
