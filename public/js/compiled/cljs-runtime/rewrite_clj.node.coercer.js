...
var G__58243 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__58244 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__58243;
lines = G__58244;
continue;
} else {
...
var comma_58245 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_58246 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_58245),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__58219){
...
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_58246,rewrite_clj.node.protocols.coerce(v),comma_58245);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__58229 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58229) : f.call(null,G__58229));
})(),sq);
});
