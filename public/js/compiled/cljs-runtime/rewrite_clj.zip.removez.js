...
return rewrite_clj.zip.whitespace.skip_whitespace.cljs$core$IFn$_invoke$arity$2(rewrite_clj.custom_zipper.core.prev,rewrite_clj.custom_zipper.core.remove((function (){var G__58305 = (left_ws_trim_fn.cljs$core$IFn$_invoke$arity$1 ? left_ws_trim_fn.cljs$core$IFn$_invoke$arity$1(zloc) : left_ws_trim_fn.call(null,zloc));
return (right_ws_trim_fn.cljs$core$IFn$_invoke$arity$1 ? right_ws_trim_fn.cljs$core$IFn$_invoke$arity$1(G__58305) : right_ws_trim_fn.call(null,G__58305));
})()));
});
/**
...
var _PERCENT_ = (function (){var ws_pred_fn = (function (p1__58307_SHARP_){
var and__5043__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_(p1__58307_SHARP_);
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.not(rewrite_clj.zip.whitespace.linebreak_QMARK_(p1__58307_SHARP_));
} else {
return and__5043__auto__;
}
});
return rewrite_clj.zip.removez.remove_with_trim(zloc,(function (p1__58308_SHARP_){
return rewrite_clj.zip.removez.left_ws_trim.cljs$core$IFn$_invoke$arity$2(p1__58308_SHARP_,ws_pred_fn);
}),(function (p1__58309_SHARP_){
return rewrite_clj.zip.removez.right_ws_trim.cljs$core$IFn$_invoke$arity$2(p1__58309_SHARP_,ws_pred_fn);
}));
})();
if(cljs.core.truth_(_PERCENT_)){
} else {
