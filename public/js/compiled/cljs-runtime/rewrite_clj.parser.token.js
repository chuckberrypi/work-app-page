...
var len__5769__auto___58093 = arguments.length;
var i__5770__auto___58094 = (0);
while(true){
if((i__5770__auto___58094 < len__5769__auto___58093)){
args__5775__auto__.push((arguments[i__5770__auto___58094]));

var G__58096 = (i__5770__auto___58094 + (1));
i__5770__auto___58094 = G__58096;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__58066){
var vec__58067 = p__58066;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58067,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__58062_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__58062_SHARP_) : allowed_QMARK_.call(null,p1__58062_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__58062_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq58063){
