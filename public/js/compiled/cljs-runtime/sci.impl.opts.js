...
var len__5769__auto___75196 = arguments.length;
var i__5770__auto___75197 = (0);
while(true){
if((i__5770__auto___75197 < len__5769__auto___75196)){
args__5775__auto__.push((arguments[i__5770__auto___75197]));

var G__75198 = (i__5770__auto___75197 + (1));
i__5770__auto___75197 = G__75198;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq75185){
var G__75186 = cljs.core.first(seq75185);
var seq75185__$1 = cljs.core.next(seq75185);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__75186,seq75185__$1);
}));
...
var G__75202 = null;
var G__75202__1 = (function (msg){
return (new Error(msg));
});
var G__75202__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__75202__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__75202 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__75202__1.call(this,msg);
case 2:
return G__75202__2.call(this,msg,filename);
case 3:
return G__75202__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__75202.cljs$core$IFn$_invoke$arity$1 = G__75202__1;
G__75202.cljs$core$IFn$_invoke$arity$2 = G__75202__2;
G__75202.cljs$core$IFn$_invoke$arity$3 = G__75202__3;
return G__75202;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__75187_SHARP_){
return (new cljs.core.Delay(p1__75187_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__75188_SHARP_){
return (new goog.string.StringBuffer(p1__75188_SHARP_));
})], null)], null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__75189 = temp__5802__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75189,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75189,(1),null);
var G__75205 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__75206 = cljs.core.rest(kvs);
class__GT_opts = G__75205;
kvs = G__75206;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__75192){
var map__75193 = p__75192;
var map__75193__$1 = cljs.core.__destructure_map(map__75193);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var disable_arity_checks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"disable-arity-checks","disable-arity-checks",1131364206));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var uberscript = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"uberscript","uberscript",701571092));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var proxy_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"proxy-fn","proxy-fn",1116677438));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75193__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var map__75194 = opts;
var map__75194__$1 = cljs.core.__destructure_map(map__75194);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var disable_arity_checks = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__75194__$1,new cljs.core.Keyword(null,"disable-arity-checks","disable-arity-checks",1131364206),new cljs.core.Keyword(null,"disable-arity-checks","disable-arity-checks",1131364206).cljs$core$IFn$_invoke$arity$1(ctx));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var uberscript = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"uberscript","uberscript",701571092));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75194__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
