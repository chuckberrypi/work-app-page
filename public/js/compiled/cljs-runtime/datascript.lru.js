...
var G__24894 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__24894) : datascript.lru.cleanup_lru.call(null,G__24894));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__24895 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24895,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24895,(1),null);
...
var datascript$lru$ICache$_get$dyn_24963 = (function (this$,key,compute_fn){
...
return datascript$lru$ICache$_get$dyn_24963(this$,key,compute_fn);
}
});
...
*/
datascript.lru.t_datascript$lru24908 = (function (limit,_STAR_impl,meta24909){
this.limit = limit;
...
(datascript.lru.t_datascript$lru24908.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24910,meta24909__$1){
var self__ = this;
var _24910__$1 = this;
return (new datascript.lru.t_datascript$lru24908(self__.limit,self__._STAR_impl,meta24909__$1));
}));

(datascript.lru.t_datascript$lru24908.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24910){
var self__ = this;
var _24910__$1 = this;
return self__.meta24909;
}));

(datascript.lru.t_datascript$lru24908.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru24908.prototype.datascript$lru$ICache$_get$arity$3 = (function (_,key,compute_fn){
var self__ = this;
var ___$1 = this;
...
(datascript.lru.t_datascript$lru24908.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta24909","meta24909",1211700083,null)], null);
}));

(datascript.lru.t_datascript$lru24908.cljs$lang$type = true);

(datascript.lru.t_datascript$lru24908.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru24908");

(datascript.lru.t_datascript$lru24908.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"datascript.lru/t_datascript$lru24908");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru24908.
 */
datascript.lru.__GT_t_datascript$lru24908 = (function datascript$lru$__GT_t_datascript$lru24908(limit,_STAR_impl,meta24909){
return (new datascript.lru.t_datascript$lru24908(limit,_STAR_impl,meta24909));
});


datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
return (new datascript.lru.t_datascript$lru24908(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
