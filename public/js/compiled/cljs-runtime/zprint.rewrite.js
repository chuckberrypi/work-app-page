...
var G__61611 = rewrite_clj.zip.next(n);
loc = G__61611;
continue;
} else {
var G__61612 = rewrite_clj.zip.next(loc);
loc = G__61612;
continue;
}
} else {
var G__61613 = rewrite_clj.zip.next(loc);
loc = G__61613;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__61587 = zloc;
var G__61587__$1 = (((G__61587 == null))?null:rewrite_clj.zip.node(G__61587));
if((G__61587__$1 == null)){
return null;
} else {
return rewrite_clj.zip.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__61587__$1);
}
})())));
});
/**
...
var G__61614 = rewrite_clj.zip.down(nloc);
nloc = G__61614;
continue;
}
break;
...
var G__61615 = rewrite_clj.zip.right(nloc);
var G__61616 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__61615;
out = G__61616;
continue;
} else {
...
var G__61619 = rewrite_clj.zip.right(replaced_loc);
var G__61620 = cljs.core.next(new_loc);
var G__61621 = replaced_loc;
nloc = G__61619;
new_loc = G__61620;
last_loc = G__61621;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__61605_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__61605_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__61605_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
