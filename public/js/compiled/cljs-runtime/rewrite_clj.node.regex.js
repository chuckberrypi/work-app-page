...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57809,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57809,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57852){
var vec__57853 = p__57852;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57853,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57853,(1),null);
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57808){
var self__ = this;
var G__57808__$1 = this;
return (new cljs.core.RecordIter((0),G__57808__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57812,other57815){
var self__ = this;
var this57812__$1 = this;
return (((!((other57815 == null)))) && ((((this57812__$1.constructor === other57815.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57812__$1.pattern,other57815.pattern)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57812__$1.__extmap,other57815.__extmap)))))));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57809){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k57809);

}
}));

(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57808){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57869 = cljs.core.keyword_identical_QMARK_;
var expr__57870 = k__5352__auto__;
if(cljs.core.truth_((pred__57869.cljs$core$IFn$_invoke$arity$2 ? pred__57869.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__57870) : pred__57869.call(null,new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__57870)))){
return (new rewrite_clj.node.regex.RegexNode(G__57808,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57808),null));
}
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57808){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,G__57808,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.regex.map__GT_RegexNode = (function rewrite_clj$node$regex$map__GT_RegexNode(G__57834){
var extmap__5385__auto__ = (function (){var G__57876 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__57834,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
return (new rewrite_clj.node.regex.RegexNode(new cljs.core.Keyword(null,"pattern","pattern",242135423).cljs$core$IFn$_invoke$arity$1(G__57834),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
