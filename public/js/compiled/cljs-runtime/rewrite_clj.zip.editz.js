...
return rewrite_clj.node.protocols.coerce((function (){var G__59588 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__59588) : f.call(null,G__59588));
})());
});
});
/**
...
var len__5769__auto___59612 = arguments.length;
var i__5770__auto___59613 = (0);
while(true){
if((i__5770__auto___59613 < len__5769__auto___59612)){
args__5775__auto__.push((arguments[i__5770__auto___59613]));

var G__59614 = (i__5770__auto___59613 + (1));
i__5770__auto___59613 = G__59614;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__59589_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__59589_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq59590){
var G__59591 = cljs.core.first(seq59590);
var seq59590__$1 = cljs.core.next(seq59590);
var G__59592 = cljs.core.first(seq59590__$1);
var seq59590__$2 = cljs.core.next(seq59590__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59591,G__59592,seq59590__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__59597 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__59597) : str_fn.call(null,G__59597));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__59598 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__59598) : str_fn.call(null,G__59598));
})()):null)));
...
var G__59603 = rewrite_clj.zip.base.tag(zloc);
var G__59603__$1 = (((G__59603 instanceof cljs.core.Keyword))?G__59603.fqn:null);
switch (G__59603__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__59601_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__59601_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__59602_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__59602_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59603__$1)].join('')));
...
var G__59609 = rewrite_clj.zip.base.tag(zloc);
var G__59609__$1 = (((G__59609 instanceof cljs.core.Keyword))?G__59609.fqn:null);
switch (G__59609__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__59608_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__59608_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59609__$1)].join('')));
