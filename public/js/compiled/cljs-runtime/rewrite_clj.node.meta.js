...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k58044,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k58044,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__58050){
var vec__58051 = p__58050;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58051,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58051,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this58045,other58046){
var self__ = this;
var this58045__$1 = this;
return (((!((other58046 == null)))) && ((((this58045__$1.constructor === other58046.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58045__$1.tag,other58046.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58045__$1.prefix,other58046.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58045__$1.children,other58046.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58045__$1.__extmap,other58046.__extmap)))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var vec__58058 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
var mta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58058,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58058,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k58044){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k58044);

}
}));

(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__58043){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__58079 = cljs.core.keyword_identical_QMARK_;
var expr__58080 = k__5352__auto__;
if(cljs.core.truth_((pred__58079.cljs$core$IFn$_invoke$arity$2 ? pred__58079.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__58080) : pred__58079.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__58080)))){
return (new rewrite_clj.node.meta.MetaNode(G__58043,self__.prefix,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__58079.cljs$core$IFn$_invoke$arity$2 ? pred__58079.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__58080) : pred__58079.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__58080)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,G__58043,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__58079.cljs$core$IFn$_invoke$arity$2 ? pred__58079.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__58080) : pred__58079.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__58080)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,G__58043,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__58043),null));
}
}
}
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__58043){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,G__58043,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.meta.map__GT_MetaNode = (function rewrite_clj$node$meta$map__GT_MetaNode(G__58047){
var extmap__5385__auto__ = (function (){var G__58104 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__58047,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__58047)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58104);
} else {
return G__58104;
}
})();
return (new rewrite_clj.node.meta.MetaNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__58047),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__58047),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__58047),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
