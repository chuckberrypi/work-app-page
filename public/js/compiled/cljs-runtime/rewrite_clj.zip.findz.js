...
var len__5769__auto___58370 = arguments.length;
var i__5770__auto___58372 = (0);
while(true){
if((i__5770__auto___58372 < len__5769__auto___58370)){
args__5775__auto__.push((arguments[i__5770__auto___58372]));

var G__58373 = (i__5770__auto___58372 + (1));
i__5770__auto___58372 = G__58373;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__58282){
var vec__58283 = p__58282;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58283,(0),null);
...
return (function (p1__58279_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__58279_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq58280){
var G__58281 = cljs.core.first(seq58280);
var seq58280__$1 = cljs.core.next(seq58280);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58281,seq58280__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__58286 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58286,(0),null);
...
var vec__58290 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__58293 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58290,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58293,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58293,(1),null);
var vec__58296 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58290,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58296,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58296,(1),null);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58302_SHARP_){
var and__5043__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__58302_SHARP_) : p_QMARK_.call(null,p1__58302_SHARP_));
if(cljs.core.truth_(and__5043__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__58302_SHARP_,pos);
} else {
return and__5043__auto__;
}
...
var G__58312 = zloc;
var G__58312__$1 = (((G__58312 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__58312) : f.call(null,G__58312)));
if((G__58312__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__58312__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__58318_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__58318_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__58327_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__58327_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__58342_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__58342_SHARP_),v);
}));
