...
rewrite_clj.node.keyword.keyword_sexpr = (function rewrite_clj$node$keyword$keyword_sexpr(kw,kw_auto_resolved_QMARK_,map_qualifier,p__57159){
var map__57160 = p__57159;
var map__57160__$1 = cljs.core.__destructure_map(map__57160);
var auto_resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57160__$1,new cljs.core.Keyword(null,"auto-resolve","auto-resolve",1851201983));
...
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var G__57162 = (cljs.core.truth_(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(q))?(function (){var G__57165 = (function (){var or__5045__auto__ = (function (){var G__57166 = new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q);
if((G__57166 == null)){
return null;
} else {
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__57166);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
var fexpr__57164 = (function (){var or__5045__auto__ = auto_resolve;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
return (fexpr__57164.cljs$core$IFn$_invoke$arity$1 ? fexpr__57164.cljs$core$IFn$_invoke$arity$1(G__57165) : fexpr__57164.call(null,G__57165));
})():new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q));
if((G__57162 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57162);
}
})(),cljs.core.name(kw));
});
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57172,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57172,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57187){
var vec__57188 = p__57187;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57188,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57188,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57173,other57174){
var self__ = this;
var this57173__$1 = this;
return (((!((other57174 == null)))) && ((((this57173__$1.constructor === other57174.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57173__$1.k,other57174.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57173__$1.auto_resolved_QMARK_,other57174.auto_resolved_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57173__$1.map_qualifier,other57174.map_qualifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57173__$1.__extmap,other57174.__extmap)))))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57172){
var self__ = this;
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57171){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57278 = cljs.core.keyword_identical_QMARK_;
var expr__57279 = k__5352__auto__;
if(cljs.core.truth_((pred__57278.cljs$core$IFn$_invoke$arity$2 ? pred__57278.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__57279) : pred__57278.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__57279)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__57171,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57278.cljs$core$IFn$_invoke$arity$2 ? pred__57278.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__57279) : pred__57278.call(null,new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__57279)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__57171,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57278.cljs$core$IFn$_invoke$arity$2 ? pred__57278.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__57279) : pred__57278.call(null,new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__57279)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,G__57171,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57171),null));
}
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57171){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,G__57171,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__57175){
var extmap__5385__auto__ = (function (){var G__57287 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57175,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720)], 0));
...
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__57175),new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(G__57175),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720).cljs$core$IFn$_invoke$arity$1(G__57175),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
