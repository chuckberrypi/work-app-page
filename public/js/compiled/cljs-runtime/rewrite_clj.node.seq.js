...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57819,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57819,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57856){
var vec__57859 = p__57856;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57859,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57859,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57818){
var self__ = this;
var G__57818__$1 = this;
return (new cljs.core.RecordIter((0),G__57818__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57822,other57823){
var self__ = this;
var this57822__$1 = this;
return (((!((other57823 == null)))) && ((((this57822__$1.constructor === other57823.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57822__$1.tag,other57823.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57822__$1.format_string,other57823.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57822__$1.wrap_length,other57823.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57822__$1.seq_fn,other57823.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57822__$1.children,other57823.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57822__$1.__extmap,other57823.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__57895 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__57895) : self__.seq_fn.call(null,G__57895));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57819){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k57819);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57818){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57928 = cljs.core.keyword_identical_QMARK_;
var expr__57929 = k__5352__auto__;
if(cljs.core.truth_((pred__57928.cljs$core$IFn$_invoke$arity$2 ? pred__57928.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__57929) : pred__57928.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__57929)))){
return (new rewrite_clj.node.seq.SeqNode(G__57818,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57928.cljs$core$IFn$_invoke$arity$2 ? pred__57928.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__57929) : pred__57928.call(null,new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__57929)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__57818,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57928.cljs$core$IFn$_invoke$arity$2 ? pred__57928.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__57929) : pred__57928.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__57929)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__57818,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57928.cljs$core$IFn$_invoke$arity$2 ? pred__57928.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__57929) : pred__57928.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__57929)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__57818,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57928.cljs$core$IFn$_invoke$arity$2 ? pred__57928.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__57929) : pred__57928.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__57929)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__57818,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57818),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57818){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__57818,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__57837){
var extmap__5385__auto__ = (function (){var G__57941 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57837,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__57837)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57941);
} else {
return G__57941;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__57837),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__57837),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__57837),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__57837),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__57837),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),(function (p1__57943_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__57943_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),(function (p1__57956_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__57956_SHARP_);
}),children);
});
